...
import type { SwiftResponse, CookieOptions, SecurityHeaders } from '../types';
...
export function enhanceResponse(res: ServerResponse): SwiftResponse {
  ...
  // Compression
  swiftRes.compress = async function (
    data: string | Buffer,
    force: boolean = false
  ): Promise<void> {
